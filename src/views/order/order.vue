                          ...
                          <span>
                            <el-button @click="comment(index, work)">追加评论</el-button>
                                    ...
                                    <td colspan="" :rowspan="item.commodity_list.length" headers=""
                                        ...
                                        <p>
                                            <span v-if="item.status.status_description === '已取消'"><el-tag
                                                type="warning">订单已取消</el-tag></span>
                                            <span v-if="item.status.status_description === '已下单'"><el-tag
                                                type="success">已下单</el-tag></span>
                                            <span v-if="item.status.status_description === '待支付'"><el-tag
                                                type="info">待支付</el-tag></span>
                                            <span v-if="item.status.status_description === '已支付'"><el-tag
                                                type="success">已支付</el-tag></span>
                                            <span v-if="item.status.status_description === '出货中'"><el-tag
                                                type="">出货中</el-tag></span>
                                            <span v-if="item.status.status_description === '已发货'"><el-tag
                                                type="info">已发货</el-tag></span>
                                            <span v-if="item.status.status_description === '运输中'"><el-tag
                                                type="info">运输中</el-tag></span>
                                            <span v-if="item.status.status_description === '已签收'"><el-tag
                                                type="info">已签收</el-tag></span>
                                            <span v-if="item.status.status_description === '交易成功'"><el-tag
                                                type="success">交易成功</el-tag></span>
                        ...
                        " class="click change-color-on-hover">
                            ...
                            <div v-show="currentComment == index" class="comment-box">
                                <div class="area">
                                    ...
                                    <el-input style="font-size: 15px;" type="textarea"
                                ...
                                <div class="area">
                                    ...
                                    <el-upload :action="globalVar.HOST_NAME + '/file/upload'" name="image"
